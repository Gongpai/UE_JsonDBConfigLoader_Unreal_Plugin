...
void FJsonDBConfigLoaderModule::StartupModule()
{
	// This code will execute after your module is loaded into memory; the exact timing is specified in the .uplugin file per-module
	
	FJsonDBConfigLoaderStyle::Initialize();
	FJsonDBConfigLoaderStyle::ReloadTextures();
	
	//Setup Other
	JsonDBCLManager = UJsonDBConfigLoaderManager::GetInstance();

	FJsonDBConfigLoaderCommands::Register();
	
	PluginCommands = MakeShareable(new FUICommandList);

	PluginCommands->MapAction(
		FJsonDBConfigLoaderCommands::Get().OpenPluginWindow,
		FExecuteAction::CreateRaw(this, &FJsonDBConfigLoaderModule::PluginButtonClicked),
		FCanExecuteAction());

	UToolMenus::RegisterStartupCallback(FSimpleMulticastDelegate::FDelegate::CreateRaw(this, &FJsonDBConfigLoaderModule::RegisterMenus));
	
	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(JsonDBConfigLoaderTabName, FOnSpawnTab::CreateRaw(this, &FJsonDBConfigLoaderModule::OnSpawnPluginTab))
		.SetDisplayName(LOCTEXT("FJsonDBConfigLoaderTabTitle", "JsonDBConfigLoader"))
		.SetMenuType(ETabSpawnerMenuType::Hidden);
}

void FJsonDBConfigLoaderModule::ShutdownModule()
{
	...
	FJsonDBConfigLoaderStyle::Shutdown();

	FJsonDBConfigLoaderCommands::Unregister();

	FGlobalTabmanager::Get()->UnregisterNomadTabSpawner(JsonDBConfigLoaderTabName);
}

TSharedRef<SDockTab> FJsonDBConfigLoaderModule::OnSpawnPluginTab(const FSpawnTabArgs& SpawnTabArgs)
{
						...
						[
							...
							[
								...
								[
									...
									.OnClicked_Raw(this, &FJsonDBConfigLoaderModule::OnButtonAddNewJson)
								]
							]
							...
							[
								...
								[
									...
									.OnClicked_Raw(this, &FJsonDBConfigLoaderModule::OnButtonCreateNewJson)
								]
							]
						]
					]
				...
				[
					...
					[
						...
						[
							...
							.OnClicked_Raw(this, &FJsonDBConfigLoaderModule::OnButtonClearList)
						]
					]
					...
					[
						...
						[
							...
							.OnClicked_Raw(this, &FJsonDBConfigLoaderModule::OnButtonClearConfig)
						]
					]
					...
					[
						...
						[
							...
							.OnClicked_Raw(this, &FJsonDBConfigLoaderModule::OnButtonSave)
						]
					]
					...
					[
						...
						[
							...
							.OnClicked_Raw(this, &FJsonDBConfigLoaderModule::OnButtonLoad)
						]
					]
				]
			]
...
void FJsonDBConfigLoaderModule::AutoShowEmptyJsonText()
{
...
FReply FJsonDBConfigLoaderModule::OnButtonClick()
{
	UE_LOG(LogTemp, Display, TEXT("ButtonClicked"));
	return FReply::Handled();
}

FReply FJsonDBConfigLoaderModule::OnButtonSave()
{
...
FReply FJsonDBConfigLoaderModule::OnButtonLoad()
{
...
FReply FJsonDBConfigLoaderModule::OnButtonAddNewJson()
{
	OnAddJson();
	return FReply::Handled();
}

void FJsonDBConfigLoaderModule::OnAddJson()
{
...
void FJsonDBConfigLoaderModule::OnDataTableChanged(const FAssetData& NewAssetData)
{
...
FReply FJsonDBConfigLoaderModule::OnButtonCreateNewJson()
{
...
FReply FJsonDBConfigLoaderModule::OnButtonClearList()
{
...
FReply FJsonDBConfigLoaderModule::OnButtonClearConfig()
{
	FOnClicked ConfirmAction;
	ConfirmAction.BindLambda([this]()->FReply
	{
...
void FJsonDBConfigLoaderModule::ClearConfig()
{
...
void FJsonDBConfigLoaderModule::OnCreateJson(FDatabaseInfo DatabaseInfo)
{
	TArray<FString> JsonFiles = JsonDBCLManager->OpenSaveFileDialog();
	AddJsonFileToDatabaseList(JsonFiles, DatabaseInfo, true);
}

void FJsonDBConfigLoaderModule::AddJsonFileToDatabaseList(TArray<FString> JsonFiles, FDatabaseInfo DatabaseInfo, bool isSave = true)
{
	if(JsonFiles.Num() <= 0)
	{
		return;
	...
	for (FString JsonFile : JsonFiles)
	{
		...
		if(isSave)
		{
			UJsonDBConfigLoaderManager::SaveJsonDBConfig(JsonFile, DatabaseInfo);
		}
		else
		{
			UJsonDBConfigLoaderManager::LoadJsonDBConfig(JsonFile, DatabaseInfo);
		}
		bool isOverride;
...
void FJsonDBConfigLoaderModule::AddJsonFileInList(FString FileName)
{
	TSharedRef<FButtonInfo> ButtonInfo = JsonFileButton(FileName, 
	FClickAction::CreateRaw(this, &FJsonDBConfigLoaderModule::OnSetCurrentJson), 
	FClickAction::CreateRaw(this, &FJsonDBConfigLoaderModule::OnButtonDelete));
...
void FJsonDBConfigLoaderModule::OnSetCurrentJson(FString* FileName)
{
...
void FJsonDBConfigLoaderModule::OnLoadJson()
{
...
void FJsonDBConfigLoaderModule::OnSaveJson()
{
	...
	}else
	{
		...
		UJsonDBConfigLoaderManager::SaveJsonDBConfig(CurrentFileInfo->FilePath, *CurrentDatabaseInfo);
	}
}

TSharedRef<FButtonInfo> FJsonDBConfigLoaderModule::JsonFileButton(FString FileName, FClickAction SelectAction, FClickAction DeleteAction)
{
...
bool FJsonDBConfigLoaderModule::ShowMessageDialog(FText Message)
{
	return FMessageDialog::Open(EAppMsgType::YesNo, Message) == EAppReturnType::Yes;
    
}

void FJsonDBConfigLoaderModule::ShowMessageDialogWithAction(FText Message, FOnClicked ConfirmAction, FOnClicked CancelAction)
{
...
TSharedPtr<SObjectPropertyEntryBox> FJsonDBConfigLoaderModule::CreateDataTableEntryBox()
{
...
void FJsonDBConfigLoaderModule::ShowNotification(FText Message, FName MessageLog)
{
...
void FJsonDBConfigLoaderModule::PluginButtonClicked()
{
	FGlobalTabmanager::Get()->TryInvokeTab(JsonDBConfigLoaderTabName);
}

void FJsonDBConfigLoaderModule::RegisterMenus()
{
...

	{
		UToolMenu* Menu = UToolMenus::Get()->ExtendMenu("LevelEditor.MainMenu.Window");
		{
			...
			Section.AddMenuEntryWithCommandList(FJsonDBConfigLoaderCommands::Get().OpenPluginWindow, PluginCommands);
		}
	}

	{
		UToolMenu* ToolbarMenu = UToolMenus::Get()->ExtendMenu("LevelEditor.LevelEditorToolBar");
		{
			...
			{
				FToolMenuEntry& Entry = Section.AddEntry(FToolMenuEntry::InitToolBarButton(FJsonDBConfigLoaderCommands::Get().OpenPluginWindow));
...
void FJsonDBConfigLoaderModule::OnButtonDelete(FString* FileName)
{
...
IMPLEMENT_MODULE(FJsonDBConfigLoaderModule, JsonDBConfigLoader)